...
import com.comfunmanager.repository.AuthorityRepository;
import com.comfunmanager.repository.UserRepository;
...
public class UserServiceImpl implements UserService {
	...
	public User create(UserCreateForm form) {
		...
		user.setPassword(/*new BCryptPasswordEncoder(10).encode(form.getPassword())*/form.getPassword());
		user.setEnabled(1);
